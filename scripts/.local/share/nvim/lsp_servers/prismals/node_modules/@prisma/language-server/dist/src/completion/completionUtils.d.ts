...
export declare function givenBlockAttributeParams(blockAttribute: '@@unique' | '@@id' | '@@index' | '@@fulltext', previewFeatures?: PreviewFeatures[] | undefined, datasourceProvider?: string | undefined): CompletionItem[];
export declare const blockAttributes: CompletionItem[];
export declare const sortAutoCompletionItems: CompletionItem[];
export declare function givenFieldAttributeParams(fieldAttribute: '@unique' | '@id' | '@@index', previewFeatures: PreviewFeatures[] | undefined, datasourceProvider: string | undefined, wordBeforePosition: string): CompletionItem[];
