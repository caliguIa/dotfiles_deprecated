...
function getBlockAtPosition(line, lines) {
    ...
    const allowedBlockIdentifiers = ['model', 'type', 'enum', 'datasource', 'generator'];
    // get block beginning
...
function getModelOrTypeOrEnumBlock(blockName, lines) {
...
exports.getModelOrTypeOrEnumBlock = getModelOrTypeOrEnumBlock;
