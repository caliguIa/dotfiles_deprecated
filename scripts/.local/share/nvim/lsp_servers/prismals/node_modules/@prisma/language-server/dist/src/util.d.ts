...
export declare type BlockType = 'generator' | 'datasource' | 'model' | 'type' | 'enum';
...
export declare function getModelOrTypeOrEnumBlock(blockName: string, lines: string[]): Block | void;
