...
function getSuggestionsForAttribute({ attribute, wordsBeforePosition, untrimmedCurrentLine, lines, block, position, }) {
    ...
    if (attribute === '@relation') {
        ...
        if ((0, util_1.isInsideAttribute)(untrimmedCurrentLine, position, '[]')) {
            if ((0, util_1.isInsideFieldArgument)(untrimmedCurrentLine, position)) {
                ...
                if (previewFeatures === null || previewFeatures === void 0 ? void 0 : previewFeatures.includes('extendedindexes')) {
                    ...
                    if (attribute) {
                        return {
                            items: (0, completionUtils_1.filterSortLengthBasedOnInput)(attribute, previewFeatures, datasourceProvider, wordBeforePosition, completionUtils_1.sortLengthProperties),
                            isIncomplete: false,
                        };
                    }
                }
        ...
        if (wordsBeforePosition.some((a) => a.includes('@@unique'))) {
            blockAtrributeArguments = (0, completionUtils_1.givenBlockAttributeParams)('@@unique');
        }
        else if (wordsBeforePosition.some((a) => a.includes('@@id'))) {
            blockAtrributeArguments = (0, completionUtils_1.givenBlockAttributeParams)('@@id');
        }
        else if (wordsBeforePosition.some((a) => a.includes('@@index'))) {
            ...
            blockAtrributeArguments = (0, completionUtils_1.givenBlockAttributeParams)('@@index', previewFeatures, datasourceProvider);
        }
        else if (wordsBeforePosition.some((a) => a.includes('@@fulltext'))) {
            blockAtrributeArguments = (0, completionUtils_1.givenBlockAttributeParams)('@@fulltext');
        }
        if (blockAtrributeArguments.length) {
            ...
            if (wordsBeforePosition.some((a) => a.includes('@unique'))) {
                ...
                fieldAtrributeArguments = (0, completionUtils_1.givenFieldAttributeParams)('@@index', previewFeatures, datasourceProvider, wordBeforePosition);
            }
