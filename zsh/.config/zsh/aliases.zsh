...
alias la="exa -la"
alias c="code ."
alias springcleaning="springcleaning.sh"
alias dotfilespush='dotfilespush.sh'
...
alias emup="cd ~/smrtzr/emulators/docker; op run -- docker-compose up;"
